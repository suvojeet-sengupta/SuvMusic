...
```json
{
  ...
  "downloadUrl": "https://ota.suvmusic.app/stable/apks/SuvMusic-v2.6.3.0.apk",
  "mirrorUrl": "https://github.com/suvojeet-sengupta/SuvMusic/releases/download/v2.6.3.0/SuvMusic-v2.6.3.0.apk",
