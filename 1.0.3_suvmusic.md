...
*   Restricted HQ Audio Source audio access to developer mode only
...
*   replaced Remote Audio branding with HQ Audio
*   fix: correctly parse artist, album and duration from more_info in Remote Audio repository
...
*   fixed remote audio artist details not loading by implementing getArtist in repository and updating viewmodel
*   comprehensive search for remote audio tab with artists, albums, and playlists
*   fetch dynamic home sections from remote audio launch data
...
*   remote audio home now fetches real api data - charts albums playlists trending
...
*   fixed remote audio playlist loading error and filtered lib playlists
...
*   added remote audio playlists to library screen
*   fix remote audio notification controls not playing by detecting empty urls
...
*   add synced lyrics from lrclib for remote audio songs
