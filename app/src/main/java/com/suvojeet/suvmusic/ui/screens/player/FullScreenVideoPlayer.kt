                    ...
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            IconButton(onClick = { showDownloadSheet = true }) {
                                when {
                                    isVideoDownloading -> M3ELoadingIndicator(color = dominantColors.primary, modifier = Modifier.size(18.dp))
                    ...
                    Row(
                        ...
                        Box(contentAlignment = Alignment.Center, modifier = Modifier.size(80.dp).background(Color.White.copy(alpha = 0.1f), RoundedCornerShape(50))) {
                            if (playerState.isLoading) {
                                M3ELoadingIndicator(color = dominantColors.primary, modifier = Modifier.size(48.dp))
                            } else {
